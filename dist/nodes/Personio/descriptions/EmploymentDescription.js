                ...
                preSend: [
                    async function (requestOptions) {
                        ...
                        if (updateFields.position) {
                            body.position = { title: updateFields.position };
                        }
                        ...
                        if (updateFields.costCenterIds) {
                            const ids = updateFields.costCenterIds
                                .split(',')
                                .map((id) => id.trim())
                                .filter((id) => id);
                            if (ids.length > 0) {
                                ...
                                body.cost_centers = ids.map((id, index) => ({
                                    id,
...
//# sourceMappingURL=EmploymentDescription.js.map